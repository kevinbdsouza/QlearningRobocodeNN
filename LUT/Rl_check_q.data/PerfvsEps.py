...
Eps1Mean = np.mean(winRateMovV) 
numRoundsNewV = np.arange(0,len(winRateMovV)*100,100)

Eps = [0,0.2,0.4,0.6,0.8,1]
EpsMean = [Eps0Mean,Eps2Mean,Eps4Mean,Eps6Mean,Eps8Mean,Eps1Mean]
#axes = plt.gca()
#axes.set_ylim([0,100])
...
plt.plot(Eps, EpsMean,c='b',linewidth=2.0)
#plt.plot(numRounds,winRate,c='r',linewidth=2.0,label="without smoothing")
plt.xlabel('Epsilon')
plt.ylabel('Average Performance')
plt.title('Avg Performance with E = 0 vs Epsilon')
plt.legend()
plt.show()
